    ...
    <aside className="sidebar">
      ...
      <nav className="sidebar__nav">
        ...
        <li className={pathname === "/admin/users" && "sidebar__menu-item sidebar__menu-item--active"}>
          ...
          <li className={pathname === "/update-user" && "sidebar__menu-item sidebar__menu-item--active"}>
          ...
          <li className={pathname === "/update-image" && "sidebar__menu-item sidebar__menu-item--active"}>
          ...
          <li className={pathname === "/update-finger-print" && "sidebar__menu-item sidebar__menu-item--active"}>
          ...
          {/* <li className="sidebar__menu-item">
            <a href="/admin/help" className="sidebar__link">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="sidebar__icon" width="20" height="20">
